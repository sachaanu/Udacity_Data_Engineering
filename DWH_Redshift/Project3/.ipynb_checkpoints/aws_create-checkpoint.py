...
def parse_config():
    """
    Parsing the dwh.cfg configuration file to read keys etc
    :param none
    """
...
def attach_iam_role_policy(iam):
    """
    Attach the S3 ReadOnlyAccess role to the IAM
    :param iam:
    :return:
    """
    global DWH_IAM_ROLE_NAME
...
def cluster_creation(redshift, roleArn):
    """
...
def get_redshift_cluster_status(redshift):
    """
    Print the Redshift cluster status
...
def check_cluster_creation(redshift):
    ...
    :param redshift: The Redshift client
    :return:bool
    """
...
def main():
    ...
    clusterCreationStarted = cluster_creation(redshift, roleArn)
